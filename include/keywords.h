...
namespace impl_exp {
    static constexpr auto kw_terms = ctpg::terms(impl::select_kw, impl::as_kw, impl::from_kw, impl::where_kw, impl::count_kw, impl::sum_kw, impl::max_kw, impl::min_kw, impl::avg_kw);
